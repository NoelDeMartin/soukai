...
- Added the ability to use multiple schemas per Model, and migrate existing data. [Read the docs](http://localhost:5173/guide/advanced/interoperability.html#model-schemas) to learn more.
